...
public class IControllerInput {
	...
	[SerializeField]
	public KeyCode Keys_up, Keys_down, Keys_left, Keys_right, Keys_action, Keys_secondary, Keys_cancel, Keys_esc, Keys_pause, Keys_start, Keys_inventory;

	public string button_up, button_down, button_left, button_right, button_action, button_secondary, button_cancel, button_inventory, button_y, button_esc, button_pause, button_start;
	...
	public virtual bool secondary(){return false;}
	...
	public virtual bool secondaryHeld(){return false;}
